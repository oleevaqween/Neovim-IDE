...
vim.opt.lazyredraw = false -- redraw while executing macros (butter UX0
...
vim.opt.spelllang = { "en" } -- Set language for spellchecks
...
vim.opt.timeoutlen = 500 -- Time in ms to wait for mapped sequences
...
vim.opt.guicursor = {
	...
	"a:blinkwait700-blinkoff400-blinkon250-Cursor/lCursor", -- All modes: blinking and highlight groups
